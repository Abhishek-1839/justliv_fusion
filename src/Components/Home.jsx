    ...
    <Work />
      <div className={styles.missionSection}>
        ...
        <p className={styles.highlight}>
          make parents' lives <strong><span style={{color:"#ff6699"}}>easier</span>, <span style={{color:"#ff6699"}}>happier</span>, and <span style={{color:"#ff6699"}}>less stressful</span>.</strong>
        </p>
